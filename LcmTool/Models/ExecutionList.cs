...
namespace LcmTool.Models
{
    ...
    public partial class ExecutionList
    {
        ...
        public string NZEVOverlap { get; set; }
        public string ServerRequiresOSLicense { get; set; }
        public Nullable<decimal> NumCores { get; set; }
        public Nullable<decimal> NumProcessors { get; set; }
        public string NZEVRemediationPlanned { get; set; }
        public string ISOExceptionNumber { get; set; }
        public string COGSupported { get; set; }
